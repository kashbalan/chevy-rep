...
public class ChevyDriverStudent {
    public static void main(String[] args) {
        ...
        int corvetteClassicMiles = corvetteClassic.getMileage();
        int corvetteSportMiles = corvetteSport.getMileage();
        if(corvetteClassicMiles < corvetteSportMiles){
            System.out.println("Classic Corvette has less miles than Sport Corvette");
        }
        else if(corvetteSportMiles < corvetteClassicMiles){
